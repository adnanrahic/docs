...
<Snippet width="100%" dark text="npm i -g @vue/cli" />
<Caption>
  Installing Vue CLI global to the system user with{' '}
...
<Snippet width="100%" dark text="vue create vue-project && cd vue-project" />
<Caption>
  Creating a bootstrapped Vue.js project and moving into the directory within a
  terminal.
</Caption>
...
<Snippet width="100%" dark text="vue add router" />
