...
<Snippet
  width="100%"
  dark
  text="npm init next-app my-next-app && cd my-next-app"
/>
<Caption>
  Initializing a Next.js project with create-next-app and npm, then moving into
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-nextjs-using-fathom-analytics-with-vercel/add-site-fathom.png`}
  width={1740 / 2}
  height={662 / 2}
  oversize
  borderRadius
...
<Caption>
  Adding the <InlineCode>fathom-client</InlineCode> dependency to the app.
</Caption>
