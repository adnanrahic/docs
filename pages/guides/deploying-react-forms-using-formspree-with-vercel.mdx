...
<Image
  src={`${process.env.ASSETS}/guides/deploying-react-forms-using-formspree-with-vercel/formspree-create.png`}
  width={780}
  height={777}
  oversize
  shadow
...
<Caption>
  The{' '}
  <b>
    Create a Form with <ProductName />
  </b>{' '}
  page on Formspree.
</Caption>
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-react-forms-using-formspree-with-vercel/formspree-recaptcha.png`}
  width={2001 / 2}
  height={399 / 2}
  oversize
  shadow
/>
<Caption>
  The <b>Settings</b> page on Formspree.
</Caption>
...
<Snippet
  width="100%"
  dark
  text="npm init react-app my-formspree-app && cd my-formspree-app"
/>
<Caption>Creating and entering into a React app.</Caption>

Add the `axios` dependency to your project:

<Snippet width="100%" dark text="npm install axios" />
<Caption>
