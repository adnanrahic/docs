...
<Image
  src={`${process.env.ASSETS}/guides/deploying-sanity-studio-with-vercel/deploying-sanity-studio-with-vercel.png`}
  width={3200 / 2.75}
  height={1684 / 2.75}
  oversize
/>
...
<Snippet width="100%" dark text="npm i -g @sanity/cli" />
<Caption>
  Adding the Sanity CLI as a global package to enable use of the{' '}
  <InlineCode>sanity</InlineCode> command.
</Caption>

To initiate a new project and download the Studio code to your computer, run the following in the command line:

<Snippet width="100%" dark text="sanity init" />
...
<Snippet width="100%" dark text="sanity start" />
...
<Snippet width="100%" dark text="npm i -D @sanity/cli" />
<Caption>
...
<Snippet
  width="100%"
  dark
  text="sanity cors add https://your-url.now.sh --credentials"
/>
