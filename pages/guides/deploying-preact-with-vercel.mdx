...
<Snippet width="100%" dark text="npm i -g preact-cli" />
<Caption>
  Installing Preact CLI globally with{' '}
...
<Snippet
  width="100%"
  dark
  text="preact create default my-preact-app && cd my-preact-app"
/>
<Caption>
  Bootstrapping a Preact app with{' '}
  <Link href="https://github.com/preactjs/preact-cli">Preact CLI</Link>.
</Caption>
