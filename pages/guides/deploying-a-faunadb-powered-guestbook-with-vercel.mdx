...
<Snippet
  width="100%"
  dark
  text="npx create-next-app --example with-graphql-faunadb my-nextjs-guestbook && cd my-nextjs-guestbook"
/>
<Caption>
  Initializing a Next.js, GraphQL, and FaunaDB app with{' '}
...
<Snippet width="100%" dark text="npm i" />
<Caption>
  Installing the dependencies for your project with{' '}
...
<Snippet width="100%" dark text="npm run setup" />
