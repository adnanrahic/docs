...
<Snippet width="100%" dark text="npm run serve" />
...
<Image
  src={`${process.env.ASSETS}/guides/vue-js-html-forms-with-formcarry-vercel/add-form.png`}
  width={1984 / 2}
  height={1104 / 2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/vue-js-html-forms-with-formcarry-vercel/form-endpoint.png`}
  width={1984 / 2}
  height={1144 / 2}
  oversize
  shadow
