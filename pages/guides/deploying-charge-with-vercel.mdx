...
<Image
  src={`${process.env.ASSETS}/guides/deploying-charge-with-vercel/deploying-charge-with-vercel.png`}
  width={2048 / 2.75}
  height={1170 / 2.75}
  oversize
/>
...
<Snippet width="100%" dark text="mkdir charge-app && cd charge-app" />
<Caption>
...
<Snippet width="100%" dark text="npm i -D @static/charge" />
<Caption>Adding Charge as a development dependency to our project.</Caption>
...
<Snippet width="100%" dark text="mkdir src && mkdir src/pages" />
<Caption>
  Creating a <InlineCode>/src</InlineCode> directory with a{' '}
  <InlineCode>/pages</InlineCode> directory inside of it.
</Caption>
...
<Caption>
  Starting up a local development server using a{' '}
  <InlineCode>package.json</InlineCode> script.
</Caption>
