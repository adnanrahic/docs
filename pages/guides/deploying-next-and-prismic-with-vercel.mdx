...
<Image
  src={`${process.env.ASSETS}/guides/deploying-next-prismic-with-vercel/deploying-next-prismic-with-vercel.png`}
  width={2048 / 2.75}
  height={1170 / 2.75}
  oversize
/>
...
<Snippet width="100%" dark text="npm i -g prismic-cli" />
<Caption>
  Installing the <InlineCode>prismic-cli</InlineCode> command line tool.
</Caption>

<Snippet
  width="100%"
  dark
  text="prismic theme https://github.com/raulg/prismic-next-blog"
/>
...
<Snippet width="100%" dark text="npm i prismic-javascript prismic-reactjs" />
<Caption>
  Adding the <InlineCode>prismic-javascript</InlineCode> and{' '}
  <InlineCode>prismic-reactjs</InlineCode> dependencies to fetch and render
  documents.
</Caption>
