...
<Image
  src={`${process.env.ASSETS}/guides/deploying-nextjs-nodejs-and-faunadb-with-vercel/fauna-create-vercel-db.png`}
  width={2048 / 2.5}
  height={1628 / 2.5}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-nextjs-nodejs-and-faunadb-with-vercel/fauna-vercel-db-shell.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-nextjs-nodejs-and-faunadb-with-vercel/fauna-vercel-db-collections.png`}
  width={2048 / 2.5}
  height={1536 / 2.5}
  oversize
  shadow
/>
<Caption>
  The Collections page on the FaunaDB dashboard after adding data to the
  database.
</Caption>
...
<Snippet
  width="100%"
  dark
  text="vercel secrets add FAUNADB_SECRET_KEY [your-access-key]"
/>
<Caption>
...
<Snippet
  width="100%"
  dark
  text="mkdir -p faunadb-demo/pages/api && mkdir faunadb-demo/components && cd faunadb-demo"
/>
<Caption>
  Creating and entering into the <InlineCode>/faunadb-demo</InlineCode>{' '}
  directory.
</Caption>
...
<Snippet width="100%" dark text="npm i faunadb next react react-dom" />
<Caption>
  Adding the <InlineCode>faunadb</InlineCode>, <InlineCode>next</InlineCode>,{' '}
  <InlineCode>react</InlineCode> and <InlineCode>react-dom</InlineCode>{' '}
