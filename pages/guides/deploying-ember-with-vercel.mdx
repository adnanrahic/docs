...
<Snippet
  width="100%"
  dark
  text="npx ember-cli new my-ember-project && cd my-ember-project"
/>
<Caption>
  Initializing an Ember project with{' '}
  <Link href="https://ember-cli.com/">ember-cli</Link> and moving into the
  project directory.
</Caption>
