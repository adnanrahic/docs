...
=======
  lastEdited: '2020-09-01T02:35:38.000Z',
>>>>>>> upstream/master
  rank: 23,
}
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-pusher-channels-with-vercel/create-new-channels-app.png`}
  width={2880 / 3}
  height={1800 / 3}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-pusher-channels-with-vercel/name-channels-app.png`}
  width={2880 / 3}
  height={1800 / 3}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-pusher-channels-with-vercel/click-newly-created-channels-app.png`}
  width={2880 / 3}
  height={1800 / 3}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/deploying-pusher-channels-with-vercel/channels-app-keys.png`}
  width={2880 / 3}
  height={1800 / 3}
  oversize
  shadow
/>
<Caption>
  Viewing the <b>App Keys</b> from the Channels dashboard.
</Caption>
...
<Snippet
  width="100%"
  dark
  text="mkdir -p pusher-channels/api && cd pusher-channels"
/>
<Caption>
  Creating and entering into a <InlineCode>/pusher-channels</InlineCode>{' '}
  directory that contains an <InlineCode>/api</InlineCode> folder.
</Caption>
...
<Snippet
  width="100%"
  dark
  text={`vercel secrets add channels-app-id [Your Channel's app ID]`}
/>
<Caption>
...
<Snippet
  width="100%"
  dark
  text={`vercel secrets add channels-app-secret [Your Channel's app Secret]`}
/>
<Caption>
...
<Snippet width="100%" dark text="cd api && npm init -y && npm i pusher" />
<Caption>
  Entering the <InlineCode>/api</InlineCode> directory, initializing the{' '}
  <InlineCode>package.json</InlineCode> file and installing the{' '}
  <InlineCode>pusher</InlineCode> dependency.
</Caption>

Create a `channels-event.js` file inside the `/api` directory that initializes a new Channels object and receives data from the [`req.body` helper method](/docs/runtimes#official-runtimes/node-js/node-js-request-and-response-objects), before invoking [`channels.trigger`](https://github.com/pusher/pusher-http-node#publishing-events) to register the event.
