...
export const meta = {
  ...
  lastEdited: '2020-07-13T16:43:56.000Z',
}
...
<Image
  src={`${process.env.ASSETS}/guides/monitoring-performance-with-calibre-and-vercel/calibre-add-site.png`}
  width={1536 / 2}
  height={892 / 2}
  shadow
/>
...
<Image
  src={`${process.env.ASSETS}/guides/monitoring-performance-with-calibre-and-vercel/calibre-github-integration.png`}
  width={1536 / 2}
  height={198 / 2}
  shadow
/>
...
<Image
  src={`${process.env.ASSETS}/guides/monitoring-performance-with-calibre-and-vercel/calibre-select-github-comparison-branch.png`}
  width={1536 / 2}
  height={608 / 2}
  shadow
/>
...
<Image
  src={`${process.env.ASSETS}/guides/monitoring-performance-with-calibre-and-vercel/calibre-pr-review-example.png`}
  width={1536 / 2}
  height={1330 / 2}
  shadow
/>
