...
export const meta = {
  ...
  lastEdited: '2020-08-25T16:08:21.000Z',
}
...
This guide walks you through setting up client-side user-experience monitoring for your <OrgName /> deployments. Once you add the script in the head tag, it will automatically send metrics to Sematext where you can debug and troubleshoot performance issues and end-user satisfaction with Web Vitals, Apdex scores, Waterfall charts showing slow-loading resources, pages and HTTPS requests, and much more.
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-performance-monitoring-with-sematext-and-vercel/step-4-start-shipping-logs.png`}
  width={1280 / 2}
  height={832 / 2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-performance-monitoring-with-sematext-and-vercel/step-4-save-token.png`}
  width={1280 / 2}
  height={800 / 2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-performance-monitoring-with-sematext-and-vercel/step-5-create-log-drain.png`}
  width={1249 / 2}
  height={1372 / 2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-performance-monitoring-with-sematext-and-vercel/step-5-logs-reports.png`}
  width={1280 / 2}
  height={800 / 2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/client-side-performance-monitoring-with-sematext-and-vercel/step-6-multiple-log-drains.png`}
  width={1249 / 2}
  height={746 / 2}
  oversize
  shadow
