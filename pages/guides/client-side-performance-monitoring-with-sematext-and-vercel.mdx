...
export const meta = {
  ...
  lastEdited: '2020-08-25T15:36:05.000Z'
}
...
This guide walks you through setting up client-side user-experience monitoring for your <OrgName /> deployments. Once you add the script in the head tag, it will automatically send metrics to Sematext where you can debug and troubleshoot performance issues and end-user satisfactopm with Web Vitals, Apdex scores, Waterfall charts showing slow-loading resources, pages and HTTPS requests, and much more.
