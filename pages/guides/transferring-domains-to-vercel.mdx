...
/>
<Caption>
  Transferring in a Domain via the <OrgName /> Dashboard.
</Caption>
...
<Snippet width="100%" dark text="vercel domains transfer-in [your-domain]" />
<Caption>
  Transferring in a Domain via <ProductShortName /> CLI.
</Caption>
...
<Snippet width="100%" dark text="vercel dns import [your-domain] [zonefile]" />
<Caption>
  Importing a DNS zone file with <ProductShortName /> CLI.
</Caption>
...
<Caption>
  Deploying with a production domain using <ProductShortName /> CLI.
</Caption>
