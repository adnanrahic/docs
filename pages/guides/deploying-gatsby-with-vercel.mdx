...
<Snippet width="100%" dark text="npm i -g gatsby-cli" />
<Caption>
  Installing{' '}
  <Link href="https://www.gatsbyjs.org/docs/gatsby-cli/">gatsby-cli</Link>{' '}
...
<Snippet width="100%" dark text="gatsby new my-gatsby-project" />
