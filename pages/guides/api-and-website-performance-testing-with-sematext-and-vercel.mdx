...
export const meta = {
  ...
  lastEdited: '2020-09-25T06:42:20.000Z',
}
...
<Image
  src={`${process.env.ASSETS}/guides/api-and-website-performance-testing-with-sematext-and-vercel/vercel-synthetics-1.png`}
  width={976 / 1.2}
  height={234 / 1.2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/api-and-website-performance-testing-with-sematext-and-vercel/vercel-synthetics-2.png`}
  width={982 / 1.2}
  height={650 / 1.2}
  oversize
  shadow
...
<Image
  src={`${process.env.ASSETS}/guides/api-and-website-performance-testing-with-sematext-and-vercel/vercel-synthetics-3.png`}
  width={835 / 1.2}
  height={759 / 1.2}
  oversize
  shadow
...
These include structured formats for website performance metrics include web vitals, page loads, HTTP requests, resource load times, SSL expiry dates, and much more.
