...
<Image
  src={`${process.env.ASSETS}/guides/deploying-angular-with-vercel/tour-of-heroes.png`}
  width={1522 / 2}
  height={1334 / 2}
  oversize
/>
...
<Snippet width="100%" dark text="npm i -g @angular/cli" />
<Caption>
  Installing Angular CLI global to the system user with{' '}
  <Link href="https://www.npmjs.com/package/@angular/cli">npm</Link>.
</Caption>

Once the installation is complete, run the following command in your terminal to create a new Angular app:

<Snippet width="100%" dark text="ng new my-new-app" />
...
<Snippet width="100%" dark text="ng serve --open" />
