...
<Snippet width="100%" dark text="npm i -g @dojo/cli @dojo/cli-create-app" />
<Caption>
  Globally installing the <InlineCode>@dojo/cli</InlineCode> and{' '}
  <InlineCode>@dojo/cli-create-app</InlineCode> packages with{' '}
...
<Snippet
  width="100%"
  dark
  text="dojo create app --name my-dojo-app && cd my-dojo-app"
/>
