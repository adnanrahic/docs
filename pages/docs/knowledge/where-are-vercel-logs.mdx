...
Function logs provide logging output for your Serverless Functions, this includes user introduced logging such as `console.log`, along with details of the request made to the function.
